...
/// important:
///
/// Make changes to the configuration before calling setup. Timeouts or logging can no longer be changed after setup.
/// note:
///
/// Head over to the <a href="https://help.phrase.com/help/phrase-over-the-air-introduction">Phrase Help Center</a>
/// to learn more about the Phrase Over the Air (OTA) SDK and how to use it in your apps.
...
/// Resets the cache and makes the newly downloaded translations available
